...
<script type="text/javascript">
	...
	function editItems() {
		//提交form
		document.itemsForm.action = "${pageContext.request.contextPath }/queryListAll.action";
		document.itemsForm.submit();
	}
...
<body>
	...
	<form name="itemsForm"
		action="${pageContext.request.contextPath }/queryList.action"
		method="post">
		查询条件：
		...
		<table width="100%" border=1>
			...
			<c:forEach items="${itemsList }" var="item">
				<tr>
					...
					<td>${item.detail }</td>
					<td><a
						href="${pageContext.request.contextPath }/editItem.action?items_id=${item.id}">修改</a></td>
				</tr>
			</c:forEach>
